...
\begin{figure}[H]
\centering\input{PIC/CH08/ED}\caption{Decomposition of arbitrary force into $x$ and $y$ components}
\end{figure}
...
\end{align}
\begin{figure}[H]
\centering\input{PIC/CH08/ED2}\caption{Equilibria of bolt forces}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH08/ICR}\caption{Illustration of ICR}
\end{figure}
...
\end{gather}
\begin{figure}[H]
\centering\input{PIC/CH08/US}\caption{Linear and nonlinear responses}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH08/ECC}\caption{Stress components of eccentrically loaded bolted connection}
\end{figure}
...
\begin{figure}[H]\centering\input{PIC/CH08/SC}
...
\begin{figure}[H]\input{PIC/CH08/ECCW}
\end{figure}
\end{exmp}
\begin{solution}
