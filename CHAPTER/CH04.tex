...
\input{PIC/CH04/KE}\caption{Illustration of effective length}
\end{figure}
...
\end{exmp}
\begin{solution}
\begin{minipage}{5cm}\centering\input{PIC/CH04/IS}
\end{minipage}
...
\end{solution}
\subsection{Development and Use of Design Chart/Table}
...
\begin{figure}[p]
\centering
\includegraphics[width=.99\textwidth]{REF/UB.STRONG.NC}
\end{figure}
\begin{figure}[p]
\centering
\includegraphics[width=.99\textwidth]{REF/UB.WEAK.NC}
\end{figure}
\begin{figure}[p]
\centering
\includegraphics[width=.99\textwidth]{REF/UC.STRONG.NC}
\end{figure}
\begin{figure}[p]
\centering
...
\begin{figure}[H]
\centering\includegraphics[width=.99\textwidth]{PIC/CH04/KEE}
...
\end{itemize}
\begin{figure}[H]
\centering\input{PIC/CH04/CF1}
\caption{Sidesway due to non-rigid columns}
\centering\input{PIC/CH04/CF2}
