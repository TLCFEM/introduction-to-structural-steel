...
\begin{itemize}
\item For bending (flexural) strength, use \boldmath{$f_y=f_{y,flange}$} as flanges are the main contributors to resistance.
\begin{figure}[H]
\centering
\input{PIC/CH02/YS1}
\end{figure}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/UC}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/UBP}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/PFC}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/TFB}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/UA}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/RHS}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[t]{5cm}
\centering\includegraphics[width=4.5cm,valign=t]{PIC/CH02/CHS}
\end{minipage}
\item Plates
...
Common diameters range from \SI{10}{\mm} to \SI{90}{\mm}.
...
\begin{figure}[H]
\centering\footnotesize
\includegraphics[scale=.35]{PIC/CH02/TEMP}
\caption{Steel strength decreases with temperature (\href{https://holocausthistorychannel.wordpress.com/2013/06/24/bending-of-rails-in-the-reinhardt-cremation-facilities-yield-strength-analysis/}{\url{https://holocausthistorychannel.wordpress.com/2013/06/24/bending-of-rails-in-the-reinhardt-cremation-facilities-yield-strength-analysis/}})}
\end{figure}
