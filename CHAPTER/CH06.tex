...
\begin{table}[H]\centering\footnotesize\caption{Proof load $N_\text{proof}$ for property class 8.8 bolts}
\begin{tabular}{cc}
	\toprule
...
\end{conditions}
The minimum bolt tension at installation, $N_{ti}$, may be taken as $N_\text{proof}$ for proof loaded bolts (\NZSSTEEL{Table~15.2.5.1}).
\begin{figure}[H]
\centering
