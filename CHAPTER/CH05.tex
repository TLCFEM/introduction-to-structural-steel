...
The factor $k_l$ is the height of load above the neutral axis. Depending on where the load is applied, some cases are more likely to buckle.
\begin{figure}[H]
\centering
...
\end{gather}
where $d_p$ is the depth of the deepest web panel, this is equal to the distance between the insides of the flanges, $d_1$, for a web without horizontal stiffening plates.
...
\begin{figure}[H]
\centering\input{PIC/CH05/BEARO}\caption{Ineffective regions are ignored}
\end{figure}
\subsection{Yielding}
...
\begin{figure}[H]
\centering\input{PIC/CH05/BAI}\caption{Envelope of biaxial moments}
\end{figure}
\clearpage
\begin{exmp}
Biaxial Design
