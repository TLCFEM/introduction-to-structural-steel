...
\begin{figure}[H]
\centering
\input{PIC/CH05/PDC}\caption{Section response}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/SC}\caption{Section capacity as a function of slenderness}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/FLT}\caption{Components of FLT buckling}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/OE}\caption{Sections less sensitive to lateral buckling}
\end{figure}
...
\end{figure}
Circular sections are free from warping. All other sections warp. Hollow sections have low warping deformation and angles have low warping stress but high warping deformation. Based on this fact, for angles, rectangular/square/circular hollow sections, narrow rectangular sections and T sections, one shall use \eqsref{eq:no_warp} to calculate $M_o$ (\NZSSTEEL{Cl. 5.6.1.3 to Cl. 5.6.1.6}). For all other sections, one shall use \eqsref{eq:warp} to compute reference moment.
...
\begin{figure}[H]
\centering
\input{PIC/CH05/KT}\caption{Definition of local axes}
\end{figure}
...
\begin{figure}[H]
\centering
\input{PIC/CH05/KL}\caption{Loads applied to different heights}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/MCR}\caption{Critical moment as a function of effective length}
\end{figure}
...
V_w=0.6f_yA_w
\end{gather}
is the yield capacity (\NZSSTEEL{\S~5.11.4.1}) while
\begin{gather}
...
\end{gather}
is the buckling capacity (\NZSSTEEL{\S~5.11.5.1}). In above equations, $d_p$ is the depth of the deepest web panel, this is equal to the distance between the insides of the flanges, $d_1$, for an unstiffened web, and $A_w=dt_w$ is the area of web.
...
\end{gather}
\begin{figure}[H]
\centering\input{PIC/CH05/VW}\caption{Design region of shear capacity}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/VM}\caption{Interaction between shear and moment}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/BL}\caption{Decomposition of biaxial moment into $x$ and $y$ components}
\end{figure}
...
\begin{figure}[H]
\centering\input{PIC/CH05/BAI}\caption{Envelop of biaxial moments}
\end{figure}
\clearpage
\begin{exmp}
Biaxial Design
